# ActiveRecord::Precounter [![Build Status](https://travis-ci.org/aileron-inc/activerecord-associations-counter.svg?branch=master)](https://travis-ci.org/ailerin-inc/activerecord-associations-counter)
